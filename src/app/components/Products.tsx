    ...
    <section id="products" className="py-24 md:py-32 bg-[#030303] border-b border-neutral-900">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <motion.div 
          ...
          className="flex overflow-x-auto pb-4 mb-12 scrollbar-none gap-2 no-scrollbar"
        >
        ...
        >
          <AnimatePresence mode="popLayout">
            {filteredProducts.map((product, index) => (
              <motion.div
                layout
                initial={{ opacity: 0, y: 150, scale: 0.8, rotateX: -45, rotateY: 15, filter: "blur(15px)" }}
                whileInView={{ opacity: 1, y: 0, scale: 1, rotateX: 0, rotateY: 0, filter: "blur(0px)" }}
                viewport={{ once: false, margin: "-50px" }}
