    ...
    <section id="rutas593" className="py-28 bg-[#060606] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          ...
          <a
            href="https://wa.me/593980798205?text=Hola!%20Quiero%20encargar%20un%20mapa%203D%20personalizado%20de%20Rutas%20593"
            target="_blank"
              ...
              <div className="w-full md:w-1/2 p-8 md:p-12 overflow-y-auto flex flex-col">
                ...
                <div className="mt-auto pt-8 border-t border-neutral-800">
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <a
                      href={`https://wa.me/593980798205?text=Hola!%20Quiero%20cotizar%20un%20${encodeURIComponent(selectedProduct.name)}%20de%20Rutas%20593`}
                      target="_blank"
                      rel="noopener noreferrer"
