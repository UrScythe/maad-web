...
export default function CustomForm({ playTick }: CustomFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const message = `Hola MAAD, mi nombre es *${formData.name}* . Tengo una propuesta para un proyecto a medida:\n\n${formData.idea}`;
    const whatsappUrl = `https://wa.me/593980798205?text=${encodeURIComponent(message)}`;
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex flex-col">
                    ...
                    <input
                      ...
                      onFocus={playTick}
                      className="bg-black/40 border border-neutral-900 focus:border-neutral-500 rounded-sm px-4 py-3 text-base text-white font-light focus:outline-none transition-colors duration-300 placeholder:text-neutral-700"
                  ...
                  <div className="flex flex-col">
                    ...
                    <input
                      ...
                      onFocus={playTick}
                      className="bg-black/40 border border-neutral-900 focus:border-neutral-500 rounded-sm px-4 py-3 text-base text-white font-light focus:outline-none transition-colors duration-300 placeholder:text-neutral-700"
                      placeholder="ej. +593 99 528 5153"
                    />
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      onFocus={playTick}
                      className="bg-black/40 border border-neutral-900 focus:border-neutral-500 rounded-sm px-4 py-3 text-base text-white font-light focus:outline-none transition-colors duration-300 resize-none placeholder:text-neutral-700 leading-relaxed"
