      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 pb-16 border-b border-neutral-900">
          ...
          <div className="md:col-span-5">
            ...
            <p className="text-neutral-500 font-light text-sm max-w-sm leading-relaxed mb-6">
          ...
          <div className="md:col-span-4">
            <h4 className="text-[10px] tracking-[0.2em] font-bold text-white uppercase mb-6">CONTACTO</h4>
            <ul className="space-y-4 text-sm font-light text-neutral-500">
              <li className="flex flex-col">
                <span className="text-[9px] tracking-widest text-neutral-600 uppercase mb-1">CORREO</span>
              ...
              <li className="flex flex-col">
                <span className="text-[9px] tracking-widest text-neutral-600 uppercase mb-1">UBICACIÓN</span>
                <span className="text-neutral-400">Ecuador</span>
              </li>
              <li className="flex flex-col">
                <span className="text-[9px] tracking-widest text-neutral-600 uppercase mb-1">WHATSAPP</span>
                <a href="https://wa.me/593999999999" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-white transition-colors duration-300">+593 99 999 9999</a>
              </li>
            </ul>
          </div>
